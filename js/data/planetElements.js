export const PLANET_ELEMENT_MODELS = {
  Mercury: {
    shortRange: {
      a: 0.38709927,
      aRate: 0.00000037,
    ...
    extendedRange: {
      ...
      longPeriRate: 0.15940013,
      longNode: 48.33961819,
      longNodeRate: -0.12214182
    }
  },
  Venus: {
    shortRange: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.05679648,
      longNode: 76.67261496,
      longNodeRate: -0.27274174
    }
  },
  Earth: {
    shortRange: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.31795260,
      longNode: -5.11260389,
      longNodeRate: -0.24123856
    }
  },
  Mars: {
    shortRange: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.45223625,
      longNode: 49.71320984,
      longNodeRate: -0.26852431
    }
  },
  Jupiter: {
    shortRange: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.18199196,
      longNode: 100.29282654,
      longNodeRate: 0.13024619,
      b: -0.00012452,
      c: 0.06064060,
      s: -0.35635438,
      f: 38.35125000
  ...
  Saturn: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.54179478,
      longNode: 113.63998702,
      longNodeRate: -0.25015002,
      b: 0.00025899,
      c: -0.13434469,
      s: 0.87320147,
      f: 38.35125000
  ...
  Uranus: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.09266985,
      longNode: 73.96250215,
      longNodeRate: 0.05739699,
      b: 0.00058331,
      c: -0.97731848,
      s: 0.17689245,
      f: 7.67025000
  ...
  Neptune: {
    ...
    extendedRange: {
      ...
      longPeriRate: 0.01009938,
      longNode: 131.78635853,
      longNodeRate: -0.00606302,
      b: -0.00041348,
      c: 0.68346318,
      s: -0.10162547,
      f: 7.67025000
...
export const PLANET_MODEL_SHORT_RANGE = {
  minJulianDay: 2378497.5,
  maxJulianDay: 2470172.5
};
